...
public class PanelBuildGeneral extends JPanel {
	...
	public PanelBuildGeneral() {
		...
		txtID = new JTextField(Settings.get("bid"));
		txtID.setColumns(10);
		...
		passPass = new JPasswordField(Settings.get("bpass"));
		...
		txtKey.setText(Settings.get("bkey").length() == Crypto.KEY_LENGTH ? Settings.get("bkey") : Util.randomString(Crypto.KEY_LENGTH));
