...
public class PanelBuildPersistance extends JPanel {
	...
	public PanelBuildPersistance() {
		...
		button.setIcon(new ImageIcon(PanelBuildPersistance.class.getResource("/icons/help.png")));
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panel.createSequentialGroup()
							.addGap(47)
							.addComponent(chckbxEnableRegistryPersistance))
						.addGroup(gl_panel.createSequentialGroup()
							.addContainerGap()
							.addComponent(lblCheckingInterval)
