...
public class PanelBuildDelay extends JPanel {
	...
	public PanelBuildDelay() {
		...
		btnRandom.setIcon(new ImageIcon(PanelBuildDelay.class.getResource("/icons/random.png")));
		...
		btnHelp.setIcon(new ImageIcon(PanelBuildDelay.class.getResource("/icons/help.png")));
