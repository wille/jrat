...
public class PanelSettingsFlags extends JPanel {
	...
	public PanelSettingsFlags() {
		...
		gl_panel.setVerticalGroup(gl_panel.createParallelGroup(Alignment.LEADING).addGroup(gl_panel.createSequentialGroup().addGap(25).addComponent(rdbtnUseLocationTo).addGap(3).addComponent(rdbtnUseSystemLanguage).addContainerGap(94, Short.MAX_VALUE)));
