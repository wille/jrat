...
import io.jrat.controller.build.Build;
import io.jrat.controller.build.BuildStatus;
import io.jrat.controller.listeners.MinimalBuildListener;
	...
	public void build() {
		...
		new Thread() {
			public void run() {
				...
				String icon = null;
				String traymsg = Main.liteVersion ? "Connected to control controller" : "";
				String traymsgfail = Main.liteVersion ? "Disconnected from controller" : "";
