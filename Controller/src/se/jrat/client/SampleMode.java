...
public class SampleMode {
	...
	public static final String[] OPERATINGSYSTEMS = new String[] { "Windows 7", "Windows 8.1", "Mac OS X Yosemite", "Ubuntu Linux", "Kali GNU/Linux", "CentOS Linux", "Debian Linux", "Elementary OS Linux", "Mint Linux", "Slackware Linux", "Arch Linux", "Gentoo Linux", "Redhat Linux", "Android" };
