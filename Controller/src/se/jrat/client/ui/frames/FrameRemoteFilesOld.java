...
public class FrameRemoteFilesOld extends JPanel {

	private JPanel contentPane;

	public Slave slave;
	public static final Map<Slave, FrameRemoteFilesOld> instances = new HashMap<Slave, FrameRemoteFilesOld>();
	...
	public FrameRemoteFilesOld(Slave slave) {
		super();
		...
		if (StoreFileBookmarks.getGlobal().getBookmarks().size() > 0) {
			...
			for (File file : StoreFileBookmarks.getGlobal().getBookmarks()) {
	...
	public void txtChanged() {
		...
		if (StoreFileBookmarks.getGlobal().contains(dir)) {
