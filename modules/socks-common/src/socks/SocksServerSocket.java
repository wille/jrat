...
public class SocksServerSocket extends ServerSocket {
     ...
     */
    public SocksServerSocket(String host, int port) throws IOException {
     ...
     * @param port Port number of the primary connection.
     */
    public SocksServerSocket(CProxy p, String host, int port) throws IOException {
     ...
     * @param port Port number of the primary connection.
     */
    public SocksServerSocket(InetAddress ip, int port) throws IOException {
     ...
     * @param port Port number of the primary connection.
     */
    public SocksServerSocket(CProxy p, InetAddress ip, int port) throws IOException {
        super(0);
