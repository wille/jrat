...
public class Socks4Proxy extends CProxy implements Cloneable {
     ...
     */
    public Socks4Proxy(CProxy p, String proxyHost, int proxyPort, String user) throws UnknownHostException {
    ...
    protected ProxyMessage formMessage(InputStream in) throws IOException {
