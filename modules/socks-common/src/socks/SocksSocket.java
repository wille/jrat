...
public class SocksSocket extends Socket {
     ...
     *                              <ol>
     *                              <p>
     *                              <li>CProxy settings say that address should be resolved
     *                              locally, but this fails.
     *                              <li>CProxy settings say that the host should be contacted
     ...
     * @see Socks5Proxy#resolveAddrLocally
     */
    public SocksSocket(CProxy p, String host, int port) throws SocksException, UnknownHostException {
    ...
    private void doDirect() throws SocksException {
        try {
            ...
            throw new SocksException(CProxy.SOCKS_DIRECT_FAILED, "Direct connect failed:" + io_ex);
        }
    }
